...
//     auto headThread = std::async(std::launch::async, &Communication, this, HEAD_ID_MIN, HEAD_ID_MAX, HEAD_INDEX_IO, std::ref(portHandlerHead), std::ref(packetHandlerHead), std::ref(groupSyncReadHead), std::ref(groupSyncWriteHead));
//     auto pupilThread = std::async(std::launch::async, &CommunicationPupil, this); // Special!
//     auto leftArmThread = std::async(std::launch::async, &Communication, this, ARM_ID_MIN, ARM_ID_MAX, LEFT_ARM_INDEX_IO, std::ref(portHandlerLeftArm), std::ref(packetHandlerLeftArm), std::ref(groupSyncReadLeftArm), std::ref(groupSyncWriteLeftArm));
//     auto rightArmThread = std::async(std::launch::async, &Communication, this, ARM_ID_MIN, ARM_ID_MAX, RIGHT_ARM_INDEX_IO, std::ref(portHandlerRightArm), std::ref(packetHandlerRightArm), std::ref(groupSyncReadRightArm), std::ref(groupSyncWriteRightArm));
//     auto bodyThread = std::async(std::launch::async, &Communication, this, BODY_ID_MIN, BODY_ID_MIN, BODY_INDEX_IO, std::ref(portHandlerBody), std::ref(packetHandlerBody), std::ref(groupSyncReadBody), std::ref(groupSyncWriteBody));
...
//     auto headThread = std::async(std::launch::async, &PowerOn, this, HEAD_ID_MIN, HEAD_ID_MAX, std::ref(portHandlerHead), std::ref(packetHandlerHead));
//     auto pupilThread = std::async(std::launch::async, &PowerOnPupil, this); // Different control table.
//     auto leftArmThread = std::async(std::launch::async, &PowerOn, this, ARM_ID_MIN, ARM_ID_MAX, std::ref(portHandlerLeftArm), std::ref(packetHandlerLeftArm));
//     auto rightArmThread = std::async(std::launch::async, &PowerOn, this, ARM_ID_MIN, ARM_ID_MAX, std::ref(portHandlerRightArm), std::ref(packetHandlerRightArm));
//     auto bodyThread = std::async(std::launch::async, &PowerOn, this, BODY_ID_MIN, BODY_ID_MAX, std::ref(portHandlerBody), std::ref(packetHandlerBody));
...
//     auto headThread = std::async(std::launch::async, &PowerOff, this, HEAD_ID_MIN, HEAD_ID_MAX, std::ref(portHandlerHead), std::ref(packetHandlerHead));
//     auto pupilThread = std::async(std::launch::async, &PowerOffPupil, this);
//     auto leftArmThread = std::async(std::launch::async, &PowerOff, this, ARM_ID_MIN, ARM_ID_MAX, std::ref(portHandlerLeftArm), std::ref(packetHandlerLeftArm));
//     auto rightArmThread = std::async(std::launch::async, &PowerOff, this, ARM_ID_MIN, ARM_ID_MAX, std::ref(portHandlerRightArm), std::ref(packetHandlerRightArm));
//     auto bodyThread = std::async(std::launch::async, &PowerOff, this, BODY_ID_MIN, BODY_ID_MAX, std::ref(portHandlerBody), std::ref(packetHandlerBody));
...
// }
// static InitClass init("EpiServos", &Create, "Source/Modules/RobotModules/EpiServos/");
